      ...
      const [purchases] = await pool.query(
         `SELECT
            ...
            JSON_ARRAYAGG(JSON_OBJECT(
               'product_id', pp.product_id, 'subtotal', pp.total, 'quantity', pp.quantity ,'name', Pr.name, 'description', Pr.description, 'sale_price', Pr.sale_price, 'category_id', Pr.category_id
            )) as products
         FROM purchases p
